...
export default function SeriesPage() {
  ...
  const fetchFnMap: Record<string, () => Promise<{ results: Movie[] }>> = {
    ...
    on_air: getOnAirSeries,
    upcoming: getUpcomingSeries,
  };
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#080a0f] text-white">
      ...
      <div className="flex flex-1 mt-0">
        ...
        {/* ── SIDEBAR ── */}
        <aside className="w-52 shrink-0 sticky top-16 h-[calc(100vh-4rem)] overflow-y-auto border-r border-white/[0.06] bg-[#0d1017] flex flex-col">
          ...
          <div className="pt-5 pb-2">
            ...
            {SORT_OPTIONS.map((opt) => (
              <button
                ...
                className={`w-full flex items-center gap-2.5 px-5 py-2 text-[12.5px] font-medium transition-all relative
          ...
          <div className="pt-3 pb-4">
            ...
            {[
              ...
              <button
                key={item.label}
                className="w-full flex items-center gap-2.5 px-5 py-2 text-[12.5px] font-medium text-white/40 hover:text-white/70 hover:bg-white/[0.03] transition-all"
              >
        ...
        <div className="flex flex-col flex-1 min-w-0">
          <div className="flex-1 px-8 py-8">
              ...
              <form onSubmit={handleSearch} className="flex items-center gap-2 shrink-0">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-56 pl-9 pr-8 py-2 rounded-lg bg-white/[0.06] border border-white/10 text-sm text-white placeholder:text-white/25 focus:outline-none focus:border-red-500/50 focus:bg-white/[0.08] transition-all"
                  />
                  {inputValue && (
                    <button
                      type="button"
                ...
                <button
                  type="submit"
                  className="px-4 py-2 rounded-lg bg-red-600 hover:bg-red-500 text-xs font-bold tracking-wide transition-colors"
                >
                  Search
                </button>
              </form>
            ...
            <GridSection
              ...
              onMovieClick={setSelectedSeries}
