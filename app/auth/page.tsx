...
// ── Poster Collage (shared, hanya render sekali) ──────────────────────────────
...
function GoogleButton() {
  return (
    <button type="button"
      className="w-full border border-white/[0.08] hover:border-white/20 hover:bg-white/[0.04] transition-all rounded-xl py-2.5 text-xs font-semibold text-white/50 hover:text-white/80 flex items-center justify-center gap-2">
  ...
  return (
    <div className="flex-1 flex flex-col justify-center py-8">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <button type="submit"
          className="mt-1 w-full bg-red-600 hover:bg-red-500 active:scale-[0.98] transition-all rounded-xl py-3 text-xs font-black tracking-widest text-white uppercase">
          Sign In
        </button>
        <OrDivider />
        <GoogleButton />
...
export default function AuthPage() {
  ...
  // Poster collage di kiri saat login, di kanan saat register
  ...
  return (
    <div className="min-h-screen flex bg-[#080a0f]" style={{ justifyContent: isLogin ? "flex-start" : "flex-end" }}>
      ...
      <div className="relative z-10 flex flex-col justify-between w-full lg:w-[40%] max-w-[480px] mx-auto lg:mx-0 lg:max-w-none px-6 sm:px-10 lg:px-16 py-8 bg-[#080a0f] overflow-hidden">
        ...
        {/* Area animasi — hanya form yang bergerak */}
